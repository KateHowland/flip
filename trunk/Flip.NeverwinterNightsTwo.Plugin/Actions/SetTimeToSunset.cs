 ...
 * 
 * This file added by Keiron Nicholson on 18/05/2010 at 17:35.
 */
...
{
	public class SetTimeToSunset : Nwn2StatementBehaviour
	{	
		...
		public SetTimeToSunset(Nwn2Fitters fitters) : base(fitters)
		{
			statementType = StatementType.Action;
			parameterCount = 0;
			components = new List<StatementComponent>(1) 
			{ 
				new StatementComponent("sunset"),
			};
		}
		...
		public override string GetNaturalLanguage(params string[] args)
		{
			...
			return "it suddenly becomes sunset";
		}
		
		
		public override StatementBehaviour DeepCopy()
		{
			return new SetTimeToSunset(fitters);
		}
	}
}