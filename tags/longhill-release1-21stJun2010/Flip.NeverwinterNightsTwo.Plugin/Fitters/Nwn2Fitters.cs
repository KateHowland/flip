...
namespace Sussex.Flip.Games.NeverwinterNightsTwo
{
	...
	public class Nwn2Fitters
	{
		...
		protected Fitter onlyInstancesOrPlayers;
		protected Fitter onlyEventRaisers;	
		protected Fitter onlyNumbers;	
		protected Fitter onlyStrings;
		...
		public Fitter OnlyInstancesOrPlayers {
			get { return onlyInstancesOrPlayers; }
		}
		...
		public Fitter OnlyStrings {
			get { return onlyStrings; }
		}
		...
		public Nwn2Fitters()
		{
			...
			onlyDoorsOrPlaceables = new InstanceFitter(new List<NWN2ObjectType>{NWN2ObjectType.Door,NWN2ObjectType.Placeable},"a door or placeable");
