...
namespace Sussex.Flip.Games.DragonAge
{
	/// <summary>
	/// Provides the ability to compile Flip source code into DAScript
	/// and attach the results to a Dragon Age module.
	/// </summary>
	public class DragonAgeFlipCompiler : FlipCompiler
	{
		#region Fields
		...
		/// <summary>
		/// Constructs a new <see cref="DragonAgeFlipCompiler"/> instance.
		/// </summary>
		public DragonAgeFlipCompiler()
		{
			game = "Dragon Age";
			targetLanguage = "DAScript";
		}
