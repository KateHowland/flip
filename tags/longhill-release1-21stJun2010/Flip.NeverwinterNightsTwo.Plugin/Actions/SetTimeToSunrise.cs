...
{
	public class SetTimeToSunrise : Nwn2StatementBehaviour
	{	
		...
		public SetTimeToSunrise()
		{
			...
			{ 
				new StatementComponent("set the time to sunrise"),
			};
		}
		...
		public override string GetNaturalLanguage(params string[] args)
		{
			...
			return "it suddenly becomes sunrise";
		}
