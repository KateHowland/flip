...
namespace Sussex.Flip.Games.NeverwinterNightsTwo
{
	...
	public class PlaceableUsed : Nwn2SlotTrigger
	{
		...
		{
			return String.Format("When {0} is used",raiserSlot.GetNaturalLanguage());
		}
		...
		public override string GetAddress()
		{
			...
			string area = ((InstanceBehaviour)RaiserBlock.Behaviour).AreaTag;
			
			return addressFactory.GetInstanceAddress("OnUsed",area,Nwn2Type.Placeable,RaiserBlock.Identifier).Value;
		}
		...
		{
			PlaceableUsed copy = new PlaceableUsed(raiserSlot.Fitter);
