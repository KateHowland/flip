 ...
 * 
 * This file added by Keiron Nicholson on 12/06/2010 at 14:49.
 */
...
{
	public class CreatePlaceableAtLocation : Nwn2StatementBehaviour
	{	
		...
		public CreatePlaceableAtLocation()
		{
		...
		public override string GetCode(params string[] args)
		{
			...
			return String.Format("CreateObject(OBJECT_TYPE_PLACEABLE,{0},{1},TRUE,{2});",sTemplate,lLocation,sTag);
		}
		...
		{
			return new CreatePlaceableAtLocation();
		}
	}
}