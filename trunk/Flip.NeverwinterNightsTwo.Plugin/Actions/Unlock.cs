 ...
 * 
 * This file added by Keiron Nicholson on 12/05/2010 at 18:56.
 */
...
{
	public class Unlock : Nwn2StatementBehaviour
	{	
		...
		public override string GetCode(params string[] args)
		{
			...
			return String.Format("SetLocked({0},0);",args);
		}
		...
		public override string GetNaturalLanguage(params string[] args)
		{
			...
			return String.Format("{0} becomes unlocked",args);
		}
