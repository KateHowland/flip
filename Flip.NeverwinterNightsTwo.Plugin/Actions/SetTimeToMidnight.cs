 ...
 * 
 * This file added by Keiron Nicholson on 18/05/2010 at 17:21.
 */
...
{
	public class SetTimeToMidnight : Nwn2StatementBehaviour
	{	
		...
		public SetTimeToMidnight(Nwn2Fitters fitters) : base(fitters)
		{
			statementType = StatementType.Action;
			parameterCount = 0;
			components = new List<StatementComponent>(1) 
			{ 
				new StatementComponent("midnight"),
			};
		}
		...
		{
			return new SetTimeToMidnight(fitters);
		}
	}
}