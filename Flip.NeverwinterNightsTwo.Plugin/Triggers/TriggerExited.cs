...
namespace Sussex.Flip.Games.NeverwinterNightsTwo
{
	...
	public class TriggerExited : Nwn2SlotTrigger
	{
		...
		{
			return String.Format("When something walks out of {0}",raiserSlot.GetNaturalLanguage());
		}
		...
		public override string GetAddress()
		{
			...
			return addressFactory.GetInstanceAddress("OnExit",behaviour.AreaTag,behaviour.Nwn2Type,RaiserBlock.Identifier).Value;
		}
		...
		{
			TriggerExited copy = new TriggerExited(raiserSlot.Fitter);
