 ...
 * 
 * This file added by Keiron Nicholson on 12/06/2010 at 13:23.
 */ 
...
{
	public class CreateCreatureAtLocation : Nwn2StatementBehaviour
	{	
		...
		public CreateCreatureAtLocation()
		{
			...
			{ 
				new StatementComponent("create copy of creature"),
		...
		{
			return new CreateCreatureAtLocation();
		}
	}
}