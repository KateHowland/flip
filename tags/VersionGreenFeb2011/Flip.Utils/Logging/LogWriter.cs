	...
	public static class LogWriter
	{
		...
		{			
			try {
				...
				StringBuilder preferredFilename = new StringBuilder(System.Windows.Forms.SystemInformation.UserName + 
				...
				System.Windows.MessageBox.Show("Something went wrong when starting to record user logs.\n" + e.ToString());
			}
		}
