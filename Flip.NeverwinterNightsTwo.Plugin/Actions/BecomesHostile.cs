 ...
 * 
 * This file added by Keiron Nicholson on 18/05/2010 at 10:01.
 */
...
{
	public class BecomesHostile : Nwn2StatementBehaviour
	{	
		...
		public BecomesHostile()
		{
			...
			{ 
				...
				new StatementComponent("becomes hostile")
			};
		}
		...
		public override string GetCode(params string[] args)
		{
			...
			code.AppendLine(String.Format("ChangeToStandardFaction({0},STANDARD_FACTION_HOSTILE);",args));
		...
		public override string GetNaturalLanguage(params string[] args)
		{
			...
			return String.Format("{0} joins the Hostile faction",args);
		}
