...
namespace Sussex.Flip.Games.NeverwinterNightsTwo
{
	...
	public class CreatureDies : Nwn2SlotTrigger
	{
		...
		{
			return String.Format("When {0} is killed",raiserSlot.GetNaturalLanguage());
		}
		...
		public override string GetAddress()
		{
			...
			return addressFactory.GetInstanceAddress("OnDeath",area,Nwn2Type.Creature,RaiserBlock.Identifier).Value;
		}
		...
		{
			return new CreatureDies(raiserSlot.Fitter);
		}
	}
}
